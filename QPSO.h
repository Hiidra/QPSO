...
#define FUNC_CHOICE "Rastrigin"                       //改！！！！！！！！！！
//二维函数
...
#define PI acos(-1)
#define leftrange  -5.12                               //  改！！！！！！！
#define rightrange 5.12                                   // 改！！！！！
#define Dim 30//粒子维度
#define PNum 40	//种群规模
#define ITE_N 2000//最大迭代次数
#define REALNUM  0    //函数的真实值                        改！！！！！！！
#define N 1//测试组数
#define L 50//每组测试数目
//#define sudu 120.0   //最大速度                 改!!!!!!!!leftrange的1/5
